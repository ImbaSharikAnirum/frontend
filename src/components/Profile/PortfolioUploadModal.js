...
import { useCreatePortfolioMutation } from "../../redux/services/portfolioAPI";
import { ReactComponent as Download } from "../../images/Download.svg";

export default function PortfolioUploadModal({ onClose }) {
  ...
  const onDrop = (acceptedFiles) => {
    ...
    const isValidSize = isImage && droppedFile.size <= 20 * 1024 * 1024;
  ...
  const handleUpload = async () => {
    ...
    formData.append("files.images", fileObject);
    try {
      ...
      >
        ...
        >
          <div style={{ padding: "16px" }}>
            ...
            >
              <div className="h5">Добавить изображение в портфолио</div>
            </div>
            {error && (
              <div
                className="Body-3"
