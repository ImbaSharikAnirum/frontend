...
export default function CreationMore({ onOpenDelete, authorId }) {
  ...
  // Показываем опцию "Удалить" только если текущий пользователь является автором
  const options =
